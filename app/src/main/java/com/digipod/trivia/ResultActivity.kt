...
import com.digipod.trivia.databinding.ActivityResultBinding
...
class ResultActivity : AppCompatActivity() {
    ...
    private fun initializeViews() {
        activityResultBinding.apply {
            ...
            if (totalScore >= 6) {
                activityResultBinding.emojiReactionImg.setImageResource(R.drawable.happy_img)
                Toast.makeText(this@ResultActivity, "Wow Great", Toast.LENGTH_SHORT).show()
            } else {
                emojiReactionImg.setImageResource(R.drawable.sad_img)
